package ca.qc.johnabbott.cs603.Dialogs;
...
import ca.qc.johnabbott.cs603.Shapes.*;
    ...
    private void updatePreview() {
        ...
        switch(toolbox.getCurrentToolName()) {
            ...
            case OVAL:
                ...
                break;
            case SQUARE:
                s = new Square(50, 50, 350, 350, toolbox.getStrokeColor(), toolbox.getStrokeWidth(), toolbox.getFillColor());
                break;
            case CIRCLE:
                s = new Circle(50, 50, 350, 350, toolbox.getStrokeColor(), toolbox.getStrokeWidth(), toolbox.getFillColor());
                break;
            default:
